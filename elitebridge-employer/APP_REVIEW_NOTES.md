...
8. **Team:** builds a live employee directory from caregivers assigned by this employer, including credentials, assignment totals and upcoming shifts.
9. **Timesheets:** displays real clock-in, break and clock-out data recorded in the Caregiver app. Employers approve submitted hours, request corrections and generate/share a formatted timesheet record.
...
12. **Account:** exposes organization profile, notifications, push settings, support, Privacy Policy, Terms of Use and sign out. Permanent deletion remains directly accessible under **More → Advanced account options → Continue to account deletion**, followed by a destructive confirmation dialog to prevent accidental deletion.
