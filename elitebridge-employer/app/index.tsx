  ...
  return (
    <View style={styles.screen}>
      ...
      <View style={styles.actionSheet}>
        ...
        {signedIn ? (
          <TouchableOpacity style={styles.primary} onPress={() => router.push("/dashboard")}><Text style={styles.primaryText}>Open employer workspace</Text></TouchableOpacity>
        ) : (
          <View style={styles.actionRow}>
            <TouchableOpacity style={styles.secondary} onPress={() => router.push("/register")}><Text style={styles.secondaryText}>Start hiring</Text></TouchableOpacity>
            <TouchableOpacity style={styles.primary} onPress={() => router.push("/sign-in")}><Text style={styles.primaryText}>Sign in</Text></TouchableOpacity>
          </View>
        )}
...
const styles = StyleSheet.create({
  ...
  brandRow: { alignItems: "center", flexDirection: "row", gap: 11, marginTop: 8 }, mark: { alignItems: "center", backgroundColor: "rgba(255,255,255,0.94)", borderRadius: 15, height: 48, justifyContent: "center", width: 48 }, markText: { color: colors.green, fontSize: 16, fontWeight: "900" }, brand: { color: "#FFFFFF", fontSize: 16, fontWeight: "900", letterSpacing: 1.5 }, product: { color: "#F0CC82", fontSize: 10, fontWeight: "900", letterSpacing: 2.5, marginTop: 2 },
  ...
  actionSheet: { backgroundColor: "#FFFFFF", borderTopLeftRadius: 28, borderTopRightRadius: 28, marginTop: -20, paddingBottom: 18, paddingHorizontal: 22, paddingTop: 20 }, sheetTitle: { color: colors.ink, fontSize: 18, fontWeight: "900", textAlign: "center" }, sheetBody: { color: colors.muted, fontSize: 12, lineHeight: 18, marginHorizontal: 12, marginTop: 5, textAlign: "center" }, actionRow: { flexDirection: "row", gap: 10 }, primary: { alignItems: "center", backgroundColor: colors.green, borderRadius: 15, flex: 1, justifyContent: "center", minHeight: 54, marginTop: 16 }, primaryText: { color: "#FFFFFF", fontSize: 15, fontWeight: "900" }, secondary: { alignItems: "center", backgroundColor: "#FFFFFF", borderColor: colors.green, borderRadius: 15, borderWidth: 1.5, flex: 1, justifyContent: "center", minHeight: 54, marginTop: 16 }, secondaryText: { color: colors.green, fontSize: 15, fontWeight: "900" },
