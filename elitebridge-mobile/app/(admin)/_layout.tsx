...
/**
 * Administrator workspace shell.
 * Uses a fixed three-item navigation bar so internal admin routes never
 * appear as extra tabs. It also blocks staff or signed-out sessions from
 * entering administrator screens.
 */
      ...
      >
        {ADMIN_TABS.map((tab) => {
          ...
          return (
            ...
            >
              <IconSymbol size={25} name={tab.icon} color={tint} />
              <Text
                numberOfLines={1}
                style={{
                  marginTop: 4,
