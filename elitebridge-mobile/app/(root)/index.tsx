...
import { ActivityIndicator, ImageBackground, Linking, StyleSheet, Text, TouchableOpacity, View } from "react-native";
...
export default function CaregiverWelcomeScreen() {
  ...
  return (
    <View style={styles.screen}>
      ...
      <ImageBackground source={require("../../assets/images/caregiver-welcome-hero.jpg")} resizeMode="cover" style={styles.hero}>
...
const styles = StyleSheet.create({
  ...
  brandRow: { alignItems: "center", flexDirection: "row", gap: 11, marginTop: 8 }, mark: { alignItems: "center", backgroundColor: "rgba(255,255,255,0.94)", borderRadius: 15, height: 48, justifyContent: "center", width: 48 }, markText: { color: "#0A4A35", fontSize: 16, fontWeight: "900" }, brand: { color: "#FFFFFF", fontSize: 16, fontWeight: "900", letterSpacing: 1.5 }, product: { color: "#F0CC82", fontSize: 10, fontWeight: "900", letterSpacing: 2.5, marginTop: 2 },
