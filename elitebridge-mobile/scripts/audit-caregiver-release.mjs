...
if (config.expo.version !== "1.2.2")
  throw new Error("Caregiver release version must be 1.2.2");
if (config.expo.ios.buildNumber !== "53")
  throw new Error("Caregiver iOS build number must be 53");
